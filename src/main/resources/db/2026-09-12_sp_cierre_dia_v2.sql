-- ═══════════════════════════════════════════════════════════════
-- sp_cierre_dia v2 — El Rincon en las Arboledas
-- Fecha: 2026-09-12
--
    ...
    IF Vp_tipo_proceso = 1 THEN
        ...
        ELSE
            ...
            INSERT INTO hist_orden (
                id_cierre, id_orden, n_nombre_cliente, t_hora_creacion,
                p_total, n_estatus_orden, id_tipo_pago, n_tipo_pago,
                source, n_tipo_consumo, resumen_items, t_fecha_cierre
            )
            SELECT
                v_id_cierre, o.id_orden, o.n_nombre_cliente, o.t_hora_creacion,
            ...
            GROUP BY o.id_orden, o.n_nombre_cliente, o.t_hora_creacion,
                     o.p_total, o.n_estatus_orden, o.id_tipo_pago,
